        ...
        <tr>
            ...
            <td>
                ...
                <ul class="description" style="max-width:640px; list-style:disc; margin-left:20px">
                    ...
                    <li><code>{adminphone}</code> — the subsales admin's number, set per season in Set Up Season &rarr; step 7. Adds roughly 12 characters, which can push a large order onto a second segment — the preview below shows the real count.<br />
                        <em>Keep it inside one sentence</em>, e.g. <code>Call {adminphone} with any questions.</code> — if no number has been set, that whole sentence is dropped, so anything you split across two sentences (like <code>Questions? Call {adminphone}.</code>) would leave the first half stranded.</li>
                </ul>
                <p class="description" style="max-width:640px">
