<?php
/**
 * Migration helper (fixed): convert legacy per-field qtys into structured `products` array inside order_data
 * Exposes function migrate_orders_products($apply = false) which returns an array summary of results.
 * This version is a cleaned copy intended to replace the malformed file.
 */
